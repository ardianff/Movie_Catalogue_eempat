...
public class DetailTvShow extends AppCompatActivity {
    public final static String TV = "extra_tv";
    ImageView imgPoster;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setSubtitle(Objects.requireNonNull(tv).getTitle());
        title = tv.getTitle();
        ...
        favorite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isFavorite()){
                    ...
                    Toast.makeText(DetailTvShow.this, title + " " +getResources().getString(R.string.remove),Toast.LENGTH_SHORT).show();
                }else {
                    ...
                    if (getContentResolver().insert(CONTENT_URI, values) != null) {
                        Toast.makeText(DetailTvShow.this, title + " " +getResources().getString(R.string.added), Toast.LENGTH_SHORT).show();
